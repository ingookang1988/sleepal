...
- id: `team_sleepal` · displayName: SleepPal 팀 (3인)
...
| `geusan` (마운틴) | **PM · 앱 + 하드웨어** | 앱·하드웨어 담당 — 세부 파트 배분은 [PLAN-02] §분해 갱신으로 | **PM — 최고 권위**(2026-08-22 인간 지시) |
| `nahyunbak` (노아) | 개발 · 온보딩 웹 + 앱 | 온보딩 웹·앱 담당 — 세부 파트 배분은 [PLAN-02] §분해 갱신으로 | contributor |
